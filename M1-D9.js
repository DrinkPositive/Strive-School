...
<script>
  ...
  btn.addEventListener("click", () => {
    ...
    for (var i = 0; i < 25; i++) {
      ...
      selectDivContainer[i].style.background = ("white");
      selectDivContainer[i].innerText = numbers[i];

    }

    selectDivContainer[number1].style.background = ("green");
    selectDivContainer[number2].style.background = ("green");
    selectDivContainer[number3].style.background = ("green");
    selectDivContainer[number4].style.background = ("green");
    selectDivContainer[number5].style.background = ("green");
